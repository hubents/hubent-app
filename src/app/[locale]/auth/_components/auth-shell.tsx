  ...
  return (
    <div className="auth-hero">
      ...
      <div className="auth-hero__inner">
        ...
        <h1 className="auth-hero__title">{t("title")}</h1>
        <p className="auth-hero__lead">{t("lead")}</p>
        ...
        <div className="auth-hero__quote">
          ...
          <div className="auth-hero__quote-meta">
            ...
            <div>
              <div className="auth-hero__name">{t("quoteName")}</div>
              <div className="auth-hero__name-sub">{t("quoteSub")}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="auth-form-col">
        <div className="auth-form-inner">
          ...
          <div className="auth-footer-meta">
            ...
            <span className="sep">·</span>
            <a href="mailto:hello@hubents.com">{t("footer.contact")}</a>
          </div>
        </div>
      </div>
