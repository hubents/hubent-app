    ...
    <EventSectionGuard eventId={eventId} section="guests">
      <div className="flex flex-col gap-3.5">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <SmallBtn icon={<IcoUpload className="h-3 w-3" />}>{t("importCsv")}</SmallBtn>
          <SmallBtn icon={<IcoDownload className="h-3 w-3" />}>{t("exportCsv")}</SmallBtn>
          <SmallBtn icon={<IcoFile className="h-3 w-3" />}>{t("downloadPdf")}</SmallBtn>
          {ed && (
            <SmallBtn
        ...
        <div className="grid grid-cols-4 gap-3">
          <GuestKpi label={t("total")} value={total} tone="white" />
          <GuestKpi label={t("confirmed")} value={confirmed} tone="success" />
          <GuestKpi label={t("pending")} value={pending} tone="warn" />
          <GuestKpi label={t("cancelled")} value={declined} tone="danger" />
        </div>
        ...
        >
          ...
          {/* Mesas */}
          <DashboardCard title={t("tables")} icon={<IcoTables className="h-4 w-4" />}>
            <div className="flex flex-col gap-2">
              {tables.length === 0 ? (
                ...
                <>
                  ...
                  >
                    <strong className="text-[var(--ink-1)]">{t("noTableSeat")}</strong>{" "}
                    {guests.filter((g) => !g.tableName).length} {t("available")}
                  </div>
                </>
              )}
            </div>
              ...
              {(() => {
                ...
                return (
                  ...
                  >
                    ...
                    <strong>{pendingMenu}</strong> {t("guestsWithoutMenu")}
                  </div>
                );
              })()}
            </div>
        ...
        >
          ...
          <div ref={ageFilterRef} className="relative">
            ...
            >
              ...
              {ageFilter === "all" ? t("ageFilter") : ageLabel(ageFilter)}
            ...
            {ageFilterOpen && (
              ...
              >
                {[
                  { v: "all" as const, l: t("allAges"), n: total },
                  { v: "adult" as const, l: t("adults"), n: adults },
                  { v: "child" as const, l: t("children"), n: children },
                  { v: "baby" as const, l: t("babies"), n: babies },
                ].map((o) => {
          ...
          >
            {filtered.length > 0 && (
              ...
              >
                ...
                {(
                  [
                    { label: t("colName"), col: "name" as SortCol },
                    { label: t("colGroup"), col: "group" as SortCol },
                    { label: t("colAge"), col: "age" as SortCol },
                    { label: t("colMenu"), col: "menu" as SortCol },
                    { label: t("colTable"), col: "table" as SortCol },
                    { label: t("colStatus"), col: "rsvp" as SortCol },
                  ]
                ).map(({ label, col }) => (
                  <div
                    key={col}
...
function AddGuestDrawer({
  ...
  return (
    <DrawerShell
      onClose={onClose}
      title={t("drawerAddGuestTitle")}
      subtitle={t("drawerAddGuestSubtitle")}
      onSubmit={handleSubmit}
      submitLabel={submitting ? t("adding") : t("add")}
    ...
    >
      ...
      >
        <DrawerField label={t("fieldFirstName")} required>
          <input
        ...
        <DrawerField label={t("fieldLastName")}>
          <input
        ...
        <DrawerField label={t("fieldEmail")}>
          <input
            type="email"
        ...
        <DrawerField label={t("fieldPhone")}>
          <input
        ...
        <DrawerField label={t("fieldGroup")}>
          <select value={d.group} onChange={(e) => set("group", e.target.value)}>
            <option value="Sin grupo">{t("noGroup")}</option>
            {groupOptions.map((g) => (
...
function AddGroupDrawer({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.error?.message || t("errorCreatingGroup"));
      }
    } catch (error) {
  ...
  return (
    <DrawerShell
      ...
      subtitle={t("addGroupSubtitle")}
      onSubmit={handleSubmit}
      submitLabel={submitting ? t("creating") : t("createGroup")}
      submitDisabled={!name.trim() || submitting}
    >
      <div className="flex flex-col gap-3.5">
        <DrawerField label={t("groupName")} required>
          <input
        ...
        <DrawerField label={t("groupNotes")}>
          <textarea
            rows={3}
            placeholder={t("groupNotesPlaceholder")}
            value={notes}
  ...
  return (
    ...
    >
        ...
        >
          <div>
            ...
            <div className="text-[11px] text-[var(--ink-3)] mt-[1px]">
              {availableGuests.length} {t("seatingPlanAvailable")}
            </div>
          </div>
          {ed && (
            <button
            ...
            >
              <IcoPlus className="h-3 w-3" /> {t("addTable")}
            </button>
          )}
        </div>
      ...
      >
        ...
        {tables.map((tbl) => {
          const pos = tablePos(tbl);
          const isCircle = tbl.shape === "round" || tbl.shape === "circle";
          const isOver = dragOverId === tbl.id;
          const seated = tableGuests(tbl);
                ...
                >
                  {seated.map((g) => (
                    <div
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        if (ed) removeGuestFromTable(g.id, tbl.id);
                      }}
                      style={{
                        width: 22,
                        height: 22,
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-[12px] text-[var(--ink-1)]">
                          {s === "rect" ? t("tableShapeRect") : t("tableShapeCircle")}
                        </div>
                      </button>
                    );
                  })}
