...
export function DeliveryNotesContent({
  ...
  async function deleteNote(id: number) {
    if (!await appConfirm({ title: "Eliminar albarán", description: "Esta acción no se puede deshacer.", confirmLabel: "Eliminar", variant: "destructive" })) return;
    try {
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            {note.status !== "cancelled" && (
                              <DropdownMenuItem
                                onClick={async () => {
                                  if (await appConfirm({ title: `Cancelar albarán`, description: `¿Cancelar el albarán ${note.number}? El estado cambiará a cancelado.`, confirmLabel: "Cancelar albarán", variant: "destructive" })) {
