...
// Time-since label for "Editado". Cheap relative formatting; no i18n lib.
function timeSince(iso: string): string {
  ...
  if (w < 4) return `Hace ${w} ${w === 1 ? "semana" : "semanas"}`;
...
export function FormsPageContent({
  ...
  const filterTabs: { id: LinkFilter; label: string; n: number }[] = [
    ...
    { id: "event", label: "Vinculados a evento", n: counts.event },
    { id: "general", label: "Generales", n: counts.general },
  ];
    ...
    <div className="space-y-4">
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        >
          ...
          >
            <RiSurveyLine size={13} /> Formularios
          </button>
          <button
            onClick={() => setViewMode("responses")}
            style={pillTabStyle(viewMode === "responses")}
          >
            <RiFileList2Line size={13} /> Respuestas
          </button>
        </div>
      </div>
        ...
        >
          ...
          >
            ...
            {canCreate && (
              ...
              >
                <RiAddLine size={13} /> Nuevo formulario
              </button>
            )}
          </div>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Se eliminarán todas las instancias y respuestas asociadas. Esta
    ...
    try {
      ...
      if (linkType === "event" && eventId) {
        ...
        if (!ij.success) {
          ...
          toast.error(ij.error || "Formulario creado, no se pudo vincular");
        } else {
      ...
      >
        ...
        >
          <div>
            ...
            >
              Dale un nombre y, si quieres, vincúlalo a un evento desde ya.
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div style={{ marginTop: 18 }}>
          ...
          <input
            ...
            placeholder="Ej. Cuestionario inicial pareja"
            style={modalInput}
          />
        </div>
        ...
        <div style={{ marginTop: 16 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            >
              <RiBriefcase4Line size={12} /> General
            </button>
            <button
              type="button"
            ...
            >
              <RiCalendarEventLine size={12} /> Vincular a evento
            </button>
          </div>
        </div>
          ...
          <>
            <div style={{ marginTop: 14 }}>
              ...
              {!eventId && (
                ...
                >
                  Selecciona un evento o cambia a &quot;General&quot;.
                </div>
              )}
            </div>
            ...
            {eventId !== "" && (
              <div style={{ marginTop: 14 }}>
                ...
                >
                  Si eliges una tarea, el formulario aparecerá dentro de ella
                  para que el cliente lo conteste.
                </div>
              </div>
            )}
          </>
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <p className="text-sm text-muted-foreground">
          {filteredSubs.length} de {total} respuestas
        </p>
      </div>
