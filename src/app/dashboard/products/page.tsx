  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Tipo de producto ── */}
        <Divider label="Tipo de producto" />
          ...
          <div>
            ...
            <NativeSelect
              ...
              onChange={(v) => {
                ...
                set("type", t);
                if (t === "servicio") set("subtype", "servicio");
        ...
        {/* ── Información general ── */}
        <Divider label="Información general" />
        <div>
          <FL>Nombre *</FL>
          <Inp
            value={form.name}
            onChange={(e) => set("name", e.target.value)}
            placeholder="Ej. Coordinación boda completa"
          />
        </div>
        <div className="grid grid-cols-2 gap-2.5">
          <div>
            <FL>SKU / Referencia</FL>
            <Inp
              value={form.sku}
              onChange={(e) => set("sku", e.target.value)}
              placeholder="COORD-BOD-01"
            />
          </div>
          <div>
            <FL>Categoría</FL>
        ...
        <div>
          ...
          <Ta
            ...
            placeholder="Descripción del producto, dimensiones, características…"
          />
        </div>
        <div>
          <FL>Detalle</FL>
          <Ta
            ...
            placeholder="Instrucciones de carga, empaquetado, montaje o entrega…"
          />
        </div>
        ...
        {form.type !== "servicio" && (
          <>
            ...
            <div className="grid grid-cols-2 gap-2.5">
              ...
              <div>
                <FL hint="(alerta)">Stock mínimo</FL>
                <Inp
                  type="number" min="0"
                  value={form.stockMin}
            ...
            {form.subtype === "alquiler" && (
              ...
              >
                ...
                <span>
                  Al añadir este producto a presupuestos y facturas, el stock se gestionará por
                  disponibilidad de fecha, evitando overbooking de alquiler.
                </span>
              </div>
            )}
          </>
...
export default function ProductsPage() {
  ...
  const COLS: SortableCol[] = [
    ...
    { label: "Almacén", field: "warehouseName" },
    { label: "Stock", field: "stock" },
    { label: "Coste", field: "cost" },
    { label: "P. Venta", field: "unitPrice" },
    { label: "IVA", field: "taxRate" },
    ...
    <div className="flex flex-col gap-5">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 gap-3">
          ...
          {!search && typeFilter === "todos" && categoryFilter === "Todas" && (
            <Btn variant="outline" size="sm" onClick={openNew}>Crear producto</Btn>
          )}
        </div>
      ) : viewMode === "list" ? (
        /* ── List view ── */
