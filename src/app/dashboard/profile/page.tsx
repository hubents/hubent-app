  ...
  return (
    <div style={{ maxWidth: 820 }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <h1 style={{ fontSize: 22, fontWeight: 600, margin: "0 0 4px", color: "var(--ink-1)" }}>Mi perfil</h1>
        <div style={{ fontSize: 13, color: "var(--ink-3)" }}>Gestiona tus datos personales y la seguridad de tu cuenta</div>
      </div>

      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>

      {/* Datos personales */}
      <SectionCard icon={UserEdit01Icon} title="Datos personales" subtitle="Nombre, foto y email de tu cuenta">
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 18 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <FieldLabel>URL de foto de perfil</FieldLabel>
            <input
              style={inp}
              value={image}
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
          ...
          <div style={{ gridColumn: "1/-1" }}>
            ...
            <input
              ...
              value={email}
              readOnly
              title="El email no se puede cambiar directamente"
            />
            <div style={{ fontSize: 11, color: "var(--ink-4)", marginTop: 4 }}>
              El email es el identificador de tu cuenta y no se puede modificar desde aquí.
            </div>
          </div>
        </div>
      ...
      {/* Seguridad */}
      <SectionCard icon={LockKeyIcon} title="Seguridad" subtitle="Cambia tu contraseña de acceso">
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div>
            ...
            {confirmPwd && confirmPwd !== newPwd && (
              <div style={{ fontSize: 11, color: "#B91C1C", marginTop: 4 }}>Las contraseñas no coinciden</div>
            )}
          </div>
        </div>
