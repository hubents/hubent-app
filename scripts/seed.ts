  ...
  const plans = await db.insert(subscriptionPlans).values([
    {
      ...
      limits: { maxUsers: 1, maxEvents: 3, maxStorage: 100 },
      isActive: true,
      sortOrder: 0,
    },
    {
      ...
      limits: { maxUsers: 5, maxEvents: 20, maxStorage: 1000 },
      isActive: true,
      sortOrder: 1,
    },
    {
      ...
      limits: { maxUsers: 15, maxEvents: -1, maxStorage: 10000 },
      isActive: true,
      sortOrder: 2,
    },
    {
      ...
      limits: { maxUsers: -1, maxEvents: -1, maxStorage: -1 },
      isActive: true,
      sortOrder: 3,
    },
  ]).returning();
